...
# cd "${WORKDIR}/apache/8.3/"
# docker build --no-cache -t asimlqt/php-apache:8.3 .
# docker push asimlqt/php-apache:8.3

# cd "${WORKDIR}/apache/8.3-dev/"
# docker build --no-cache -t asimlqt/php-apache:8.3-dev .
# docker push asimlqt/php-apache:8.3-dev
...
# cd "${WORKDIR}/fpm/8.3/"
# docker build --no-cache -t asimlqt/php-fpm:8.3 .
# docker push asimlqt/php-fpm:8.3

# cd "${WORKDIR}/fpm/8.3-dev/"
# docker build --no-cache -t asimlqt/php-fpm:8.3-dev .
# docker push asimlqt/php-fpm:8.3-dev
